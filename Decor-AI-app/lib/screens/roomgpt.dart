...
class _RoomGPTState extends State<RoomGPT> {
  ...
  Future<void> changeWallColor(
      BuildContext context, String base64, String color) async {
    try {
      ...
      final response =
          await http.post(Uri.parse('http://172.20.16.1:8000/login/ml-model/'),
              body: jsonEncode({
                "image": base64,
                          ...
                          return AlertDialog(
                              ...
                              child: ColorPicker(
                                ...
                                onColorChanged: (color) {
                                  setState(() {
                                    _wallColor = color;
                                    hexString =
                                        _wallColor.value.toRadixString(16);
                                    print(_wallColor);
                                    print(hexString);
                                  });
                                },
                            ...
                            actions: <Widget>[
                              ...
                              TextButton(
                                child: const Text('OK'),
                                onPressed: () async {
                                  final bytes = await File(imageFile!.path)
                                      .readAsBytesSync();
                                  String base64Encode = base64.encode(bytes);
                                  print(base64Encode);
                                  Navigator.of(context).pop();
                                  changeWallColor(
                                      context, base64Encode, hexString);
                  ...
                  Container(
                    ...
                    child: DropdownButton<String>(
                      ...
                      onChanged: (String? newValue) async {
                        ...
                        final bytes =
                            await File(imageFile!.path).readAsBytesSync();
                        String base64Encode = base64.encode(bytes);
                        changeWallColor(context, base64Encode, ogColor);
                      },
                      items:
                          color.map<DropdownMenuItem<String>>((String value) {
