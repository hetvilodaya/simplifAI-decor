...
import wall3 from "../assets/images/wallart3.png";
import wall4 from "../assets/images/wallart4.png";
  ...
  return (
    <div>
      <div className="banner">
        <p className="banner-title">Generate your dream  home!</p>
        <Controller>
          ...
          <div className="row">
            <div className="col-lg-4">
              <div className="service-item mb-5" data-aos="fade-left">
                <h4 className="my-3">Real time image processing</h4>
                <p>
                  We aim to provide a real time view of the current room and the potential Design of the room using artificial intelligence
                </p>
              </div>
            </div>
            <div className="col-lg-4">
